...
- [x] `integrations/llm/agent_base.py`の実装
- [x] NyaoAgent基底クラス
- [x] LiteLLM統合
- [x] リトライ機能
- [x] テストコードの作成
...
- [x] `integrations/llm/prompts.py`の実装
- [x] 応答判定プロンプトテンプレート
- [x] 応答生成プロンプトテンプレート
- [x] テストコードの作成
...
- [x] `integrations/llm/judge_agent.py`の実装
- [x] ResponseJudgeAgentクラス
- [x] 応答判定ロジック
- [x] JSONレスポンスパース
- [x] フォールバック処理
- [x] テストコードの作成
...
- [x] `integrations/llm/generator_agent.py`の実装
- [x] ResponseGeneratorAgentクラス
- [x] 応答生成ロジック
- [x] 応答の後処理
- [x] テストコードの作成
